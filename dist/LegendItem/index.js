...
const LegendItem = ({
  ...
  const maxCharactersStyle = maxCharacters === -1 ? {} : {
  ...
  }, renderedIcon), /*#__PURE__*/React.createElement("span", {
    className: "legend-text",
    style: maxCharactersStyle
  }, target.disabled ? disabledText({
    legend: target,
    disabledTextColor
  }) : /*#__PURE__*/React.createElement("span", null, target.label)));
};
